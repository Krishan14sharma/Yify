...
public class MainActivity extends BaseToolBarActivity {
     ...
     */
    public static class PlaceholderFragment extends Fragment implements MainView, MainActivityAdapter.EOLReached {
...
//            presenter=component.getMainPresenter(); // one other way to get the object
        ...
        public void showData(MovieListWrapper movieListWrapper) {
            ...
            mRecyclerView.setAdapter(new MainActivityAdapter(getActivity(), movieListWrapper));
        }
